...
class NewWindow(QDialog):
    def __init__(self):
        ...
        dialog.subCancelButton.clicked.connect(self.clickedSubCancel)
        dialog.subEnrollButton.clicked.connect(self.clickedSubEnroll)
    ...
    def clickedSubCancel(self):
        print("hello world")
        self.close()

    def clickedSubEnroll(self):
        print("hello world")
